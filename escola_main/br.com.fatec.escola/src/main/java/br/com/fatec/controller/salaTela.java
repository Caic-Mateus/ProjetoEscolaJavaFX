 ...
 * @author caicm
 */
public class salaTela extends Application{
    ...
    public void start(Stage tela) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(Principal.class.getResource("view/cadastro_Sala.fxml"));
       ...
       // Cinetec_cadastroController controler = fxmlLoader.getController();
        ...
        tela.setTitle("Escola Livro Aberto - Cadastro De Salas");
        tela.setScene(scene);
        tela.show();        
